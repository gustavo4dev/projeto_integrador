...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Nov-2016 às 16:12
...
INSERT INTO `cliente` (`idCliente`, `nome`, `cpf`, `telefone`, `sexo`, `nascimento`, `email`, `senha`, `loginExt`) VALUES
(1, 'Guilherme', '00000000000', '0000000000', 'm', '2005-06-14', 'gui@gui.com', '827ccb0eea8a706c4c34a16891f84e7b', 0),
(2, 'Gustavo', '11111111111', '1111111111', 'm', '1994-09-03', 'girardigustavo.03@gmail.com', '698dc19d489c4e4db73e28a713eab07b', 0);
...
--
ALTER TABLE `combinacao`
  MODIFY `idCombinacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
