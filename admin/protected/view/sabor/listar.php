<h2>Lista de sabores de pizzas</h2>
    ...
    <?php if (count($dados) == 0) { ?>
        ...
        foreach ($dados as $item) {
            ...
            <tr>
                ...
                <td><a href='index.php?ctrl=sabor&acao=excluir&id=<?php echo $id ?>' onclick="return confirm('Deseja excluir este registro?')"><i class="material-icons">delete</i></a></td>
            </tr>
        <?php }
    }
    ?>
